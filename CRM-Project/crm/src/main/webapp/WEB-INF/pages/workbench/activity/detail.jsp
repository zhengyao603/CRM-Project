		...
		<c:forEach items="${activityRemarkList}" var="remark">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> ${remark.edit_flag == "1" ? remark.edit_time : remark.create_time} 由${remark.edit_flag == "1" ? remark.edit_by : remark.edit_by}</small>
